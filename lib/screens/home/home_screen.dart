    ...
    if (user != null) {
      ...
      _onlineUsersSubscription = FirebaseFirestore.instance
        ...
        .listen((snapshot) {
          ...
          setState(() {
            onlineUsers = users;
            Logger.debug('Online users updated: ${users.length}');
          });
        }, onError: (error) {
      ...
      currentUser.reload().then((_) {
        ...
        if (refreshedUser != null) {
          setState(() {
            ...
            Logger.debug('User data loaded: $userName, $userEmail');
          });
        }
      }).catchError((error) {
        Logger.error('Error reloading user data', error);
      });
    }
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.pushNamed(context, AppRoutes.upgradeMembership);
                          },
                ...
                child: GridView.count(
                  ...
                  children: [
                    _buildMenuButton(
                      ...
                      label: 'Take The\nTest',
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.testConfirmation);
                      },
                    ),
                    _buildMenuButton(
                      icon: Icons.history,
                      label: 'Previous\nResults',
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.previousResults);
                      },
                    ),
                    _buildMenuButton(
                      icon: Icons.school,
                    ...
                    _buildMenuButton(
                      ...
                      label: 'SuDorms',
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.dorms);
                      },
                    ),
                    _buildMenuButton(
